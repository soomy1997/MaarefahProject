...
class EditSessionDetails extends StatefulWidget {
  @override
  _EditSessionDetailsPage createState() => _EditSessionDetailsPage();
}

class _EditSessionDetailsPage extends State<EditSessionDetails> {
          ...
          children: [
            ...
            TableRow(
                ...
                children: [
                  ...
                  Container(
                    padding: EdgeInsets.fromLTRB(15, 10, 25, 10),
                    child: typeValueChoose == 'Additional Skills Courses'
                        ? TextFormField(
                            obscureText: false,
                            validator: nameValidation,
                            initialValue: 'Lorem Ipsum',
